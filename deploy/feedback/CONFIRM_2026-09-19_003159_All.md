...
- When: 2026-09-19T00:31:59.4577434+02:00
- Hard failures: 0

```
GSignalX Confirm  2026-09-19 00:31:58
...
PASS  Services\ProfitScouter_Service.log -> Result: 0 errors, 0 warnings, 3045 ms elapsed, cpu='X64 Regular'
PASS  Experts\ProfitScouter_DollarTarget.log -> Result: 0 errors, 0 warnings, 3664 ms elapsed, cpu='X64 Regular'
PASS  Services\ProfitOpportunity_Grader.log -> Result: 0 errors, 0 warnings, 1486 ms elapsed, cpu='X64 Regular'
PASS  Services\GsignalX_Service.log -> Result: 0 errors, 0 warnings, 5087 ms elapsed, cpu='X64 Regular'
PASS  Experts\GsignalX_Multisymbol_Dashboard.log -> Result: 0 errors, 0 warnings, 8620 ms elapsed, cpu='X64 Regular'
PASS  Experts\GsignalX_GocityGroup.log -> Result: 0 errors, 0 warnings, 7592 ms elapsed, cpu='X64 Regular'
PASS  Scripts\ProfitHarvest_Now.log -> Result: 0 errors, 0 warnings, 696 ms elapsed, cpu='X64 Regular'
...
INFO  signals json count for f7108c4d : 7
WARN  signals count 7 <20 (load PropDesk_30 preset for 20-30 scale)
PASS  scouter snapshot f7108c4d
--- Bus race probe (rapid reads) ---
PASS  bus race probe: 0 empty/truncated of 140 reads
=== GATE Grades ===
PASS  grades\latest.json
PASS  grades version=1
WARN  grades ts age~10799s (is Grader running?)
INFO  entry items~7  harvest items~4
