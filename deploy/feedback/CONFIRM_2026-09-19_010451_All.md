...
- When: 2026-09-19T01:04:51.0890118+02:00
- Hard failures: 0

```
GSignalX Confirm  2026-09-19 01:04:50
...
PASS  Services\ProfitScouter_Service.log -> Result: 0 errors, 0 warnings, 2942 ms elapsed, cpu='X64 Regular'
PASS  Experts\ProfitScouter_DollarTarget.log -> Result: 0 errors, 0 warnings, 3764 ms elapsed, cpu='X64 Regular'
PASS  Services\ProfitOpportunity_Grader.log -> Result: 0 errors, 0 warnings, 1504 ms elapsed, cpu='X64 Regular'
PASS  Services\GsignalX_Service.log -> Result: 0 errors, 0 warnings, 5180 ms elapsed, cpu='X64 Regular'
PASS  Experts\GsignalX_Multisymbol_Dashboard.log -> Result: 0 errors, 0 warnings, 8802 ms elapsed, cpu='X64 Regular'
PASS  Experts\GsignalX_GocityGroup.log -> Result: 0 errors, 0 warnings, 8072 ms elapsed, cpu='X64 Regular'
PASS  Scripts\ProfitHarvest_Now.log -> Result: 0 errors, 0 warnings, 699 ms elapsed, cpu='X64 Regular'
...
INFO  indexed tids: 1
WARN  multi-tid: only 1 indexed (start a second terminal for full multi-desk confirm)
WARN  heartbeat f7108c4d age~10800s (stale if publishers stopped)
INFO  signals json count for f7108c4d : 12
WARN  signals count 12 <20 (load PropDesk_30 preset for 20-30 scale)
PASS  scouter snapshot f7108c4d
--- Bus race probe (rapid reads) ---
PASS  bus race probe: 0 empty/truncated of 240 reads
=== GATE Grades ===
PASS  grades\latest.json
PASS  grades version=1
WARN  grades ts age~10799s (is Grader running?)
INFO  entry items~8  harvest items~4
