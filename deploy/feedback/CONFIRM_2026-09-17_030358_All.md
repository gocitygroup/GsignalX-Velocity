...
- When: 2026-09-17T03:03:58.5610359+02:00
- Hard failures: 0

```
GSignalX Confirm  2026-09-17 03:03:58
...
PASS  Services\ProfitScouter_Service.log -> Result: 0 errors, 0 warnings, 2539 ms elapsed, cpu='X64 Regular'
PASS  Experts\ProfitScouter_DollarTarget.log -> Result: 0 errors, 0 warnings, 3049 ms elapsed, cpu='X64 Regular'
PASS  Services\ProfitOpportunity_Grader.log -> Result: 0 errors, 0 warnings, 1451 ms elapsed, cpu='X64 Regular'
PASS  Services\GsignalX_Service.log -> Result: 0 errors, 0 warnings, 4842 ms elapsed, cpu='X64 Regular'
PASS  Experts\GsignalX_Multisymbol_Dashboard.log -> Result: 0 errors, 0 warnings, 12945 ms elapsed, cpu='X64 Regular'
PASS  Experts\GsignalX_GocityGroup.log -> Result: 0 errors, 0 warnings, 11139 ms elapsed, cpu='X64 Regular'
PASS  Scripts\ProfitHarvest_Now.log -> Result: 0 errors, 0 warnings, 674 ms elapsed, cpu='X64 Regular'
...
WARN  signals count 1 <20 (load PropDesk_30 preset for 20-30 scale)
PASS  scouter snapshot f7108c4d
--- Bus race probe (rapid reads) ---
PASS  bus race probe: 0 empty/truncated of 20 reads
=== GATE Grades ===
PASS  grades\latest.json
PASS  grades version=1
WARN  grades ts age~10801s (is Grader running?)
