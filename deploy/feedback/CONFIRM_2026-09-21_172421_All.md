...
- When: 2026-09-21T17:24:21.8018733+02:00
- Hard failures: 3

```
GSignalX Confirm  2026-09-21 17:24:21
...
PASS  Services\ProfitScouter_Service.log -> Result: 0 errors, 0 warnings, 5010 ms elapsed, cpu='X64 Regular'
PASS  Experts\ProfitScouter_DollarTarget.log -> Result: 0 errors, 0 warnings, 5321 ms elapsed, cpu='X64 Regular'
PASS  Services\ProfitOpportunity_Grader.log -> Result: 0 errors, 0 warnings, 2188 ms elapsed, cpu='X64 Regular'
PASS  Services\GsignalX_Service.log -> Result: 0 errors, 0 warnings, 7233 ms elapsed, cpu='X64 Regular'
PASS  Experts\GsignalX_Multisymbol_Dashboard.log -> Result: 0 errors, 0 warnings, 13487 ms elapsed, cpu='X64 Regular'
PASS  Experts\GsignalX_GocityGroup.log -> Result: 0 errors, 0 warnings, 11970 ms elapsed, cpu='X64 Regular'
PASS  Scripts\ProfitHarvest_Now.log -> Result: 0 errors, 0 warnings, 885 ms elapsed, cpu='X64 Regular'
...
WARN  grades ts age~10795s (is Grader running?)
